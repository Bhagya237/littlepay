...
public class TripProcessorImplTest {
    ...
    public void trip_bind_values() {
        ...
        List<Trip> trips = tripProcessor.processTrips(List.of(tap2, tap1));
    ...
    public void calculate_trip_duration() {
        ...
        List<Trip> trips = tripProcessor.processTrips(List.of(tap1, tap2));
    ...
    public void calculate_incomplete_trip_duration() {
        ...
        List<Trip> trips = tripProcessor.processTrips(List.of(tap1));
    ...
    public void single_customer_multiple_bus_trips_types() {
        ...
        List<Trip> trips = tripProcessor.processTrips(List.of(tap1, tap2, tap5, tap3, tap4));
    ...
    public void multiple_customer_multiple_bus_trips_types() {
        ...
        List<Trip> trips = tripProcessor.processTrips(List.of(tap1, tap2, tap5, tap6, tap3, tap4, tap7));
